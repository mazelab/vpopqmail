...
class MazelabVpopqmail_Model_Dataprovider_Core_Pager_Forwarder
    ...
    implements Core_Model_Dataprovider_Interface_Search
{
    ...
    public function __construct($ownerId = null, $domainId = null)
    {
        ...
        $this->_getCollection()->deleteIndex(array(
            self::KEY_TYPE => 1
        ));
    ...
    public function page($limit, $page, $searchTerm = null)
    {
        ...
        foreach($mongoCursor->sort($sort)->skip($skip)->limit($limit) as $forwarderId => $forwarder) {
            $forwarder[self::KEY_ID] = $forwarderId;
            $result['data'][$forwarderId] = $forwarder;
        }
